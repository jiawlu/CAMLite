...
class Simulation:
    def __init__(self):
        ...
        self.Simulation_EndTimeInMin = 0.0
    ...
    def setParameters(self,net, demands, signal_manager, args):
    ...
    def generateCostTree(self):
        ...
        for mesolink in net.meso_link_list:
            ...
            for lane_node_set in mesolink.micro_node_list:
                for node_id in lane_node_set:
                    mesolink.estimated_cost_tree_for_each_movement[-1][
                        net.micro_node_id_to_seq_no_dict[node_id]] = _MAX_COST_TREE
    ...
    def startSim(self):
        ...
        for t in range(number_of_simu_intervals):
            ...
            if t % number_of_simu_interval_per_min == 0:
                ...
                printProgress(t * self.number_of_seconds_per_interval / 60 + self.Simulation_StartTimeInMin, self.Simulation_EndTimeInMin, width=30)
            ...
            for agent_no in active_agent_list:
                ...
                if agent.m_Veh_LinkDepartureTime_in_simu_interval[-1] == t:
                    ...
                    for outgoing_link_id in current_node.m_outgoing_link_list:
                        ...
                        if net.meso_link_id_to_seq_no_dict[outgoing_link.meso_link_id] != agent.current_meso_link_seq_no:
                            continue
                    ...
                    if len(cost_changing_list) == 0:
                        ...
                        if cost_keeping == _MAX_COST_TREE:
                            ...
                            agent.m_Veh_LinkArrivalTime_in_simu_interval.append(t)
                            agent.m_Veh_LinkDepartureTime_in_simu_interval.append(t + outgoing_link_keeping.free_flow_travel_time_in_simu_interval)
                        else:
                            agent.m_Veh_LinkDepartureTime_in_simu_interval[-1] += 1
                            continue
